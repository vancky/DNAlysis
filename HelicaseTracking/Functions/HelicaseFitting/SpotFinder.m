function [ output ] = SpotFinder( config , inputImage )
   ...
   filteredImage = BallSmooth( RollingBallFilter( inputImage , config.rollingBallConstant ) , 1 );
   thresholdFinder = ThresholdFinder( filteredImage );
   binaryImage = 1.5*thresholdFinder.thresholdedImage>0;
