...
%         cam0 = preProcess.cam0{i};
%         cam1 = preProcess.cam1{i};
%         
...
%     
    for ii = 2:2
        ...
        numMatches = size(matchLocations, 1);
        cam0 = preProcess.cam0{ii};
        cam1 = preProcess.cam1{ii};
        
        green = GreyscaleToColor( cam0, [2 25], 'green'); 
        red =  GreyscaleToColor( cam1, [0 200], 'red');
